...
RSpec.describe PlanVersionDuplicator do
  describe ".call" do
    it "duplicates a plan version and its associations" do
      ...
      plan_cost_share = create(:cost_share, scope: source_version, cost_share_type: :deductible, amount: 100, per: :per_year, currency: "USD")
      create(:cost_share, scope: plan_module, cost_share_type: :excess, amount: 50, per: :per_condition, currency: "USD")
      ...
      create(:cost_share, scope: benefit_limit_group, cost_share_type: :excess, amount: 75, per: :per_visit, currency: "USD")
      ...
      all_new_cost_share_ids = plan_scope_cost_shares + module_scope_cost_shares + module_benefit_scope_cost_shares + benefit_limit_group_scope_cost_shares
