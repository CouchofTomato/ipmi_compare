class CreatePlanModuleRequirements < ActiveRecord::Migration[8.1]
  def change
    create_table :plan_module_requirements do |t|
      ...
      t.references :module, null: false, foreign_key: { to_table: :plan_modules }
      t.references :requires_module, null: false, foreign_key: { to_table: :plan_modules }

      t.timestamps
    end

    add_index :plan_module_requirements,
          [ :plan_id, :module_id, :requires_module_id ],
          unique: true,
